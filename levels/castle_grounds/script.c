...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		MARIO_POS(0x01, 0, -52, -17, 875),
		OBJECT(MODEL_TOAD, -75, -177, 29, 0, 0, 0, 0x00000000, bhvToadMessage),
		OBJECT(MODEL_NONE, -52, -17, 875, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
	...
	AREA(2, castle_grounds_area_2),
		...
		OBJECT(MODEL_BITS_WARP_PIPE, -25, 3585, 2417, 0, 0, 0, 0x00000000, bhvWarpPipe),
